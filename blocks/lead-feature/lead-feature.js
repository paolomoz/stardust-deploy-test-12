/**
 * lead-feature — hero-scale lead claim (improvement 2).
 * Authoring rows: heading | body | CTA (<strong><a>) | picture.
 */
...
export default async function decorate(block) {
  ...
  wrap.className = 'wrap lf-grid';
  const col = document.createElement('div');
  col.className = 'lf-text';
  if (headEl) {
